...
module.exports = function(session, libs) {
	...
	return new libs.builder.HeroCard(session)
    	...
    	.images([
            libs.builder.CardImage.create(session, 'https://thumb7.shutterstock.com/mosaic_250/623251/272061365/stock-vector-simple-quill-and-inkwell-black-vector-image-272061365.jpg')
        ]);
};
